...
public class CustomAnnotationExampleApplication {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CustomAnnotationExampleApplication.class);

    public static void main(String[] args) {
        System.setProperty("server.port", "8080");
        SpringApplication app = new SpringApplication(CustomAnnotationExampleApplication.class);
