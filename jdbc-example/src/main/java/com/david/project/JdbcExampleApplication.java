...
public class JdbcExampleApplication {
    ...
    private static final Logger logger = LoggerFactory.getLogger(JdbcExampleApplication.class);

    public static void main(String[] args) {
        System.setProperty("server.port", "8080");
        SpringApplication app = new SpringApplication(JdbcExampleApplication.class);
